	...
	args = {
		...
		global = {
			...
			args = {
				...
				colour = {
					order = 2,
					name = function(info) return (SunnArt:GetAll("theme") == "solid" and L["Solid colour"]) or L["Filter colour"] end,
					desc = function(info) return (SunnArt:GetAll("theme") == "solid" and L["Colour of the Solid Colour theme"]) or L["Colour of the filter to apply to artwork"] end,
					type = "color",
				},
				filter = {
					order = 3,
					name = L["Filter"],
					desc = L["Enable colour filter"],
					type = "toggle",
					disabled = function(info) return (SunnArt:GetAll("theme") == "solid") end,
				},
				theme = {
					order = 4,
					name = L["Theme"],
				...
				horizviewport = {
					...
					set = function(info,v) 
						...
						if v then SunnArt:GraphicsBugFix() end
					end,
				},
				vertviewport = {
					order = 10,
				...
				hideblizzart = {
					order = 14,
					name = L["Hide Blizzart Art"],
					desc = L["Hide the gryphons on the Blizzard action bar."],
					type = "toggle",
					get = function(info) return (SunnArt.db.global.hideblizzart) end,
					set = function(info,v)
						SunnArt.db.global.hideblizzart = v
						SunnArt:UpdateViewport()
					end,
				},
				worldframeglow = {
					order = 15,
					name = L["Disable Glow FX"],
					desc = L["Disable worldframe glow and death effects"],
					type = "toggle",
					get = function(info) return (SunnArt.db.global.worldframeglow) end,
					set = function(info, v)
						SunnArt.db.global.worldframeglow = v
						if v then SetCVar("ffxGlow", 0) else SetCVar("ffxGlow", 1) end
					end,
				},
				centerspellalerts = {
					order = 16,
					name = L["Center Spell Alerts"],
					desc = L["Keep spell alerts centered when the viewport is changed"],
					type = "toggle",
					get = function(info) return (SunnArt.db.global.centerspellalerts) end,
					set = function(info, v)
						SunnArt.db.global.centerspellalerts = v
						if v then 
							SunnArt:MoveSpellAlerts()
						else
				...
				centeruierrors = {
					order = 17,
					name = L["Center UI Messages"],
					desc = L["Keep UI messages centered when the viewport is changed"],
					type = "toggle",
					get = function(info) return (SunnArt.db.global.centeruierrors) end,
					set = function(info, v)
						SunnArt.db.global.centeruierrors = v
						if v then 
							SunnArt:MoveUIErrors()
						else
							point, relativeTo, relativePoint, xOfs, yOfs = UIErrorsFrame:GetPoint()
							UIErrorsFrame:ClearAllPoints()
							UIErrorsFrame:SetPoint(point, UIParent, relativePoint, xOfs, yOfs)
						end
					end,
				},
				globalspacer2 = {
			...
			args = {
				bottom = {
					...
					args = {
						...
						colour = {
							order = 11,
							name = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","bottom","theme"})] == L["Solid colour"] and L["Solid colour"]) or L["Filter colour"] end,
							desc = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","bottom","theme"})] == L["Solid colour"] and L["Colour of the Solid Colour theme"]) or L["Colour of the filter to apply to artwork"] end,
							type = "color",
							hidden = "isHidden",
						},
						filter = {
							...
							type = "toggle",
							hidden = "isHidden",
							disabled = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","bottom","theme"})] == L["Solid colour"]) end,
						},
						theme = {
							order = 13,
							name = L["Theme"],
				...
				top = {
					...
					args = {
						...
						colour = {
							order = 11,
							name = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","top","theme"})] == L["Solid colour"] and L["Solid colour"]) or L["Filter colour"] end,
							desc = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","top","theme"})] == L["Solid colour"] and L["Colour of the Solid Colour theme"]) or L["Colour of the filter to apply to artwork"] end,
							type = "color",
							hidden = "isHidden",
						},
						filter = {
							...
							type = "toggle",
							hidden = "isHidden",
							disabled = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","top","theme"})] == L["Solid colour"]) end,
						},
						theme = {
							order = 13,
							name = L["Theme"],
				...
				left = {
					...
					args = {
						...
						colour = {
							order = 11,
							name = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","left","theme"})] == L["Solid colour"] and L["Solid colour"]) or L["Filter colour"] end,
							desc = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","left","theme"})] == L["Solid colour"] and L["Colour of the Solid Colour theme"]) or L["Colour of the filter to apply to artwork"] end,
							type = "color",
							hidden = "isHidden",
						},
						filter = {
							...
							type = "toggle",
							hidden = "isHidden",
							disabled = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","left","theme"})] == L["Solid colour"]) end,
						},
						theme = {
							order = 13,
							name = L["Theme"],
				...
				right = {
					...
					args = {
						...
						colour = {
							order = 11,
							name = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","right","theme"})] == L["Solid colour"] and L["Solid colour"]) or L["Filter colour"] end,
							desc = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","right","theme"})] == L["Solid colour"] and L["Colour of the Solid Colour theme"]) or L["Colour of the filter to apply to artwork"] end,
							type = "color",
							hidden = "isHidden",
						},
						filter = {
							...
							type = "toggle",
							hidden = "isHidden",
							disabled = function(info) return (SunnArt.ThemeDB.index[SunnArt:GetValue({"panels","right","theme"})] == L["Solid colour"]) end,
						},
						theme = {
							order = 14,
							name = L["Theme"],
...
function SunnArt:SetTheme(panel, ThemeFile)
	if panel == 0 then
		...
		self:SetAll("filter", false)
		self:SetColour(0, 0, 0, 0, 1)
	else
		...
		self.db.profile.bar[panel].filter = false
		self:SetColour(panel, 0, 0, 0, 1)
	end
end
...
function SunnArt:SetValue(info, ...)
	...
	elseif this == "theme" then
		...
		if this == "resize" and args[1] then SunnArt:GraphicsBugFix() end
	end
	self:SetViewport()
end
