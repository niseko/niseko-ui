...
VUHDO_SPELL_ID.HOLY_WORD_CHASTISE = VUHDO_getSpellInfo(88625); -- Segenswort: Z�chtigung
...
VUHDO_NAME_TO_SPELL = {
	...
	["Gu�rison de l'ombre"] = VUHDO_SPELL_ID.FLASH_HEAL, -- see: https://wow.curseforge.com/projects/vuhdo/issues/964
