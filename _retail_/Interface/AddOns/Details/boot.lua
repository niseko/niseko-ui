...
--> global name declaration
		...
		_detalhes.build_counter = 7166
		_detalhes.alpha_build_counter = 7166 --if this is higher than the regular counter, use it instead
