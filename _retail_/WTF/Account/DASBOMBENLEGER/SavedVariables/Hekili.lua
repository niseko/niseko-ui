...
HekiliDB = {
	...
	["profiles"] = {
				...
				["Elemental"] = {
					...
					["lists"] = {
						...
						["single_target"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.ascendance.enabled & cooldown.lava_burst.remains > 0 & ( ! talent.storm_elemental.enabled || storm_elemental.up ) & ( ! talent.icefury.enabled || ! buff.icefury.up & ! cooldown.icefury.up )",
								["action"] = "ascendance",
							}, -- [2]
							{
								["enabled"] = true,
		...
		["Nyanporo - Blackmoore"] = {
			...
			["packs"] = {
				["Marksmanship"] = {
					["source"] = "# https://github.com/simulationcraft/simc/blob/bfa-dev/profiles/PreRaids/PR_Hunter_Marksmanship.simc",
					["builtIn"] = true,
					["date"] = 20181230.2115,
					["author"] = "SimC",
					["desc"] = "# Marksmanship Hunter\n# https://github.com/simulationcraft/simc/blob/bfa-dev/profiles/PreRaids/PR_Hunter_Marksmanship.simc\n# December 30, 2018 - 21:14\n\n# Changes:\n# - Added Counter Shot.\n# - Added Rapid Fire over Aimed Shot if you are moving.\n# - Use time_to_die rather than target.time_to_die to anticipate end of combat.",
					["lists"] = {
						["trickshots"] = {
							{
								["action"] = "barrage",
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.trick_shots.up & buff.precise_shots.down",
								["action"] = "aimed_shot",
							}, -- [4]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.trick_shots.down || buff.precise_shots.up || focus > 70",
								["action"] = "multishot",
							}, -- [6]
							{
						...
						["cds"] = {
							{
								["enabled"] = true,
								["criteria"] = "debuff.hunters_mark.down",
								["action"] = "hunters_mark",
							}, -- [1]
							{
								["enabled"] = true,
								["criteria"] = "time_to_die < 15 || cooldown.aimed_shot.remains < gcd & ( buff.trueshot.up || ! talent.calling_the_shots.enabled ) & ( ! azerite.surging_shots.enabled & ! talent.streamline.enabled & ! azerite.focused_fire.enabled )",
								["action"] = "double_tap",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "cooldown.rapid_fire.remains < gcd & ( buff.trueshot.up || ! talent.calling_the_shots.enabled ) & ( azerite.surging_shots.enabled || talent.streamline.enabled || azerite.focused_fire.enabled )",
								["action"] = "double_tap",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "cooldown.trueshot.remains > 60",
								["action"] = "berserking",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "cooldown.trueshot.remains > 30",
								["action"] = "blood_fury",
							}, -- [5]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.trueshot.react & buff.bloodlust.react || buff.trueshot.up & target.health.pct < 20 & talent.careful_aim.enabled || time_to_die < 25",
								["action"] = "potion",
							}, -- [9]
							{
								["enabled"] = true,
								["criteria"] = "buff.bloodlust.up || time_to_die > cooldown.trueshot.duration_guess + duration || ( target.health.pct < 20 || ! talent.careful_aim.enabled ) || time_to_die < 15",
								["action"] = "trueshot",
							}, -- [10]
						},
						["st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "focus < 50 & ( buff.bloodlust.up & buff.trueshot.up || buff.trueshot.down )",
								["action"] = "rapid_fire",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "buff.master_marksman.up & buff.trueshot.up & focus + cast_regen < focus.max",
								["action"] = "arcane_shot",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "buff.movement.up & ( focus + cast_regen < focus.max || azerite.focused_fire.enabled || azerite.in_the_rhythm.rank > 1 || azerite.surging_shots.enabled || talent.streamline.enabled )",
								["action"] = "rapid_fire",
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "buff.precise_shots.down || cooldown.aimed_shot.full_recharge_time < action.aimed_shot.cast_time || buff.trueshot.up",
								["action"] = "aimed_shot",
							}, -- [8]
							{
								["enabled"] = true,
								["criteria"] = "focus + cast_regen < focus.max || azerite.focused_fire.enabled || azerite.in_the_rhythm.rank > 1 || azerite.surging_shots.enabled || talent.streamline.enabled",
								["action"] = "rapid_fire",
							}, -- [9]
							{
								["action"] = "piercing_shot",
							...
							{
								["enabled"] = true,
								["criteria"] = "focus > 60 || buff.precise_shots.up & buff.trueshot.down",
								["action"] = "arcane_shot",
							}, -- [11]
							{
								["action"] = "steady_shot",
				...
				["Beast Mastery"] = {
					...
					["lists"] = {
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.bestial_wrath.up & buff.aspect_of_the_wild.up & ( target.health.pct < 35 || ! talent.killer_instinct.enabled ) || time_to_die < 25",
								["action"] = "potion",
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "buff.frenzy.up & buff.frenzy.remains <= gcd.max || full_recharge_time < gcd.max & cooldown.bestial_wrath.remains",
								["action"] = "barbed_shot",
							}, -- [8]
							{
								["action"] = "lights_judgment",
							...
							{
								["enabled"] = true,
								["criteria"] = "spell_targets > 2 & gcd.max - buff.beast_cleave.remains > 0.25",
								["action"] = "multishot",
							}, -- [14]
							{
								["enabled"] = true,
								["criteria"] = "cooldown.aspect_of_the_wild.remains > 20 || time_to_die < 15",
							...
							{
								["enabled"] = true,
								["criteria"] = "spell_targets > 1 & gcd.max - buff.beast_cleave.remains > 0.25",
								["action"] = "multishot",
							}, -- [18]
							{
								["action"] = "kill_command",
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.frenzy.down & ( charges_fractional > 1.8 || buff.bestial_wrath.up ) || cooldown.aspect_of_the_wild.remains < 6 & azerite.primal_instincts.enabled || time_to_die < 9",
								["action"] = "barbed_shot",
							}, -- [23]
							{
								["action"] = "barrage",
							...
							{
								["enabled"] = true,
								["criteria"] = "( active_enemies < 2 || cooldown.kill_command.remains > focus.time_to_max ) & ( focus - cost + focus.regen * ( cooldown.kill_command.remains - 1 ) > action.kill_command.cost || cooldown.kill_command.remains > 1 + gcd ) & cooldown.kill_command.remains > 1",
								["action"] = "cobra_shot",
							}, -- [25]
							{
								["action"] = "arcane_torrent",
						...
						["precombat"] = {
							...
							}, -- [6]
							{
								...
								["precast_time"] = "1.1",
								["action"] = "aspect_of_the_wild",
								["criteria"] = "! azerite.primal_instincts.enabled",
							}, -- [7]
							{
								["enabled"] = true,
								["precast_time"] = "1.5",
				...
				["Survival"] = {
					...
					["lists"] = {
						["wfi_st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "azerite.wilderness_survival.enabled & next_wi_bomb.volatile & dot.serpent_sting.remains > 2.1 * gcd & dot.serpent_sting.remains < 3.5 * gcd & cooldown.wildfire_bomb.remains > 2.5 * gcd",
								["action"] = "mongoose_bite",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "full_recharge_time < gcd || ( focus + cast_regen < focus.max ) & ( next_wi_bomb.volatile & dot.serpent_sting.ticking & dot.serpent_sting.refreshable || next_wi_bomb.pheromone & ! buff.mongoose_fury.up & focus + cast_regen < focus.max - action.kill_command.cast_regen * 3 )",
								["action"] = "wildfire_bomb",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "focus + cast_regen < focus.max & buff.tip_of_the_spear.stack < 3 & ( ! talent.alpha_predator.enabled || buff.mongoose_fury.stack < 5 || focus < action.mongoose_bite.cost )",
								["action"] = "kill_command",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "dot.internal_bleeding.stack < 3 & dot.shrapnel_bomb.ticking & ! talent.mongoose_bite.enabled",
								["action"] = "raptor_strike",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "next_wi_bomb.shrapnel & buff.mongoose_fury.down & ( cooldown.kill_command.remains > gcd || focus > 60 ) & ! dot.serpent_sting.refreshable",
								["action"] = "wildfire_bomb",
							}, -- [7]
							{
								["action"] = "steel_trap",
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.vipers_venom.react || refreshable & ( ! talent.mongoose_bite.enabled || ! talent.vipers_venom.enabled || next_wi_bomb.volatile & ! dot.shrapnel_bomb.ticking || azerite.latent_poison.enabled || azerite.venomous_fangs.enabled || buff.mongoose_fury.stack = 5 )",
								["action"] = "serpent_sting",
							}, -- [10]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.mongoose_fury.up || focus > 60 || dot.shrapnel_bomb.ticking",
								["action"] = "mongoose_bite",
							}, -- [12]
							{
								["action"] = "raptor_strike",
						...
						["default"] = {
							...
							}, -- [3]
							{
								["enabled"] = true,
								["action"] = "call_action_list",
								["criteria"] = "active_enemies < 3 & talent.wildfire_infusion.enabled & talent.alpha_predator.enabled & talent.mongoose_bite.enabled",
								["list_name"] = "mb_ap_wfi_st",
							}, -- [4]
							{
								["enabled"] = true,
								["action"] = "call_action_list",
								["criteria"] = "active_enemies < 3 & talent.wildfire_infusion.enabled",
								["list_name"] = "wfi_st",
							}, -- [5]
							{
								["enabled"] = true,
						...
						["st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.birds_of_prey.enabled & buff.coordinated_assault.up & ( buff.coordinated_assault.remains < gcd || buff.blur_of_talons.up & buff.blur_of_talons.remains < gcd )",
								["action"] = "mongoose_bite",
							}, -- [2]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.vipers_venom.react & buff.vipers_venom.remains < gcd",
								["action"] = "serpent_sting",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "focus + cast_regen < focus.max & ( ! talent.alpha_predator.enabled || full_recharge_time < gcd )",
								["action"] = "kill_command",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "focus + cast_regen < focus.max & ( full_recharge_time < gcd || ! dot.wildfire_bomb.ticking & ( buff.mongoose_fury.down || full_recharge_time < 4.5 * gcd ) )",
								["action"] = "wildfire_bomb",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "buff.vipers_venom.react & dot.serpent_sting.remains < 4 * gcd || ! talent.vipers_venom.enabled & ! dot.serpent_sting.ticking & ! buff.coordinated_assault.up",
								["action"] = "serpent_sting",
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "refreshable & ( azerite.latent_poison.rank > 2 || azerite.latent_poison.enabled & azerite.venomous_fangs.enabled || ( azerite.latent_poison.enabled || azerite.venomous_fangs.enabled ) & ( ! azerite.blur_of_talons.enabled || ! talent.birds_of_prey.enabled || ! buff.coordinated_assault.up ) )",
								["action"] = "serpent_sting",
							}, -- [8]
							{
								["action"] = "steel_trap",
							...
							{
								["enabled"] = true,
								["criteria"] = "focus + cast_regen < focus.max & ( buff.mongoose_fury.stack < 4 || focus < action.mongoose_bite.cost )",
								["action"] = "kill_command",
							}, -- [14]
							{
								["enabled"] = true,
								["criteria"] = "buff.mongoose_fury.up || focus > 60",
								["action"] = "mongoose_bite",
							}, -- [15]
							{
								["action"] = "raptor_strike",
						...
						["cds"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "cooldown.coordinated_assault.remains > 60 || time_to_die < 11",
								["action"] = "berserking",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "buff.coordinated_assault.up & ( buff.berserking.up || buff.blood_fury.up || ! race.troll & ! race.orc ) || time_to_die < 26",
								["action"] = "potion",
							}, -- [6]
							{
								["enabled"] = true,
						...
						["mb_ap_wfi_st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "next_wi_bomb.shrapnel & focus > 60 & dot.serpent_sting.remains > 3 * gcd",
								["action"] = "wildfire_bomb",
							}, -- [8]
							{
								["enabled"] = true,
								["criteria"] = "refreshable & ( next_wi_bomb.volatile & ! dot.shrapnel_bomb.ticking || azerite.latent_poison.enabled || azerite.venomous_fangs.enabled )",
								["action"] = "serpent_sting",
							}, -- [9]
							{
								["enabled"] = true,
						...
						["cleave"] = {
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "active_enemies > 5 & 5 || active_enemies",
								["var_name"] = "carve_cdr",
							}, -- [1]
							{
								["action"] = "a_murder_of_crows",
							...
							{
								["enabled"] = true,
								["criteria"] = "! talent.guerrilla_tactics.enabled || full_recharge_time < gcd",
								["action"] = "wildfire_bomb",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "debuff.latent_poison.stack = 10",
								["action"] = "mongoose_bite",
							}, -- [6]
							{
								["action"] = "chakrams",
							...
							{
								["enabled"] = true,
								["criteria"] = "full_recharge_time < gcd || ! talent.wildfire_infusion.enabled || dot.shrapnel_bomb.ticking & dot.internal_bleeding.stack < 3",
								["action"] = "butchery",
							}, -- [9]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "refreshable & buff.tip_of_the_spear.stack < 3",
								["action"] = "serpent_sting",
								["cycle_targets"] = 1,
							}, -- [17]
							{
								["enabled"] = true,
								["criteria"] = "debuff.latent_poison.up",
								["action"] = "mongoose_bite",
							}, -- [18]
							{
								["enabled"] = true,
					...
					["lists"] = {
						...
						["default"] = {
							...
							}, -- [2]
							{
								["enabled"] = true,
								["action"] = "call_action_list",
								["criteria"] = "! opener_done & ( ( cooldown.berserk.remains > 0 || buff.berserk.up ) || buff.incarnation.up )",
								["list_name"] = "opener",
							}, -- [3]
							{
								["enabled"] = true,
						...
						["generators"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! selection || dot.rake.remains > ( action.shred.cost + action.rake.cost - energy ) % energy.regen || buff.clearcasting.react || ! ( target.time_to_die > dot.rake.remains + variable.rake_ttd )",
								["action"] = "shred",
							}, -- [16]
						},
						["finishers"] = {
				...
				["Balance"] = {
					...
					["lists"] = {
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "astral_power >= 40 & dot.sunfire.remains > 8 & dot.moonfire.remains > 12 & ( dot.stellar_flare.remains > 6 || ! talent.stellar_flare.enabled )",
								["action"] = "incarnation",
							}, -- [17]
							{
								["enabled"] = true,
								["criteria"] = "astral_power >= 40 & ( ! azerite.lively_spirit.enabled || buff.lively_spirit.up ) & ( buff.starlord.stack >= 2 || ( ( ! talent.starlord.enabled || ! azerite.streaking_stars.enabled ) & dot.sunfire.remains > 2 & dot.moonfire.ticking & ( dot.stellar_flare.ticking || ! talent.stellar_flare.enabled ) ) )",
